...
public class Aggregate extends Operator {
    ...
    private DbIterator aggregator_iterator;
	...
	// some code goes here
    	...
    	if(aggregatorType == Type.INT_TYPE){
    		aggr = new IntegerAggregator(gfield, groupType, afield, aop);
    	}
    	else{
    		aggr = new StringAggregator(gfield, groupType, afield, aop);
    	}
    }
	...
	// some code goes here
    	...
    	aggregator_iterator = aggr.iterator();
    	aggregator_iterator.open();
    }
	...
	// some code goes here
    	if(aggregator_iterator.hasNext()){
    		return aggregator_iterator.next(); 
    	}
    	else{
    		return null;
    	}
	...
	fieldType[0] = child.getTupleDesc().getFieldType(afield);
	fieldType[1] = child.getTupleDesc().getFieldType(gfield);
